...
public record PoseData(PoseElement hmd, PoseElement mainHand, PoseElement offhand){
    ...
    public static PoseData read(VisorByteBuf buf){
        return new PoseData(PoseElement.read(buf), PoseElement.read(buf), PoseElement.read(buf));
    }
}
